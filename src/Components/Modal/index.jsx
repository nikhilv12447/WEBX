...
function Modal({ title, children, onClose, style, containerStyle }) {
    ...
    return <div className={`flex z-10 justify-center items-center fixed top-0 left-0 w-full h-full bg-[#0C111DB3] ${containerStyle}`}>
        <div className={`bg-white rounded-xl relative z-10 ${style}`}>
