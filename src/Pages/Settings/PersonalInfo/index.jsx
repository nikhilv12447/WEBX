...
function PersonalInfo({ }) {
    return <div>
        <div className="bg-white p-6 flex flex-row items-center justify-between max-mob:block rounded-2xl border border-[#0023334D] mb-6">
            ...
            <div className="flex flex-row max-xsmob:block gap-3">
                <Button Icon={MessageIcon} title="Submit Feedback" style="feedback-btn" containerStyle="max-xsmob:mb-2" secondaryBtn isHover={false} />
        ...
        <div className="bg-white rounded-2xl border border-[#0023334D] p-6">
            <div className="flex justify-between">
                ...
                <Button Icon={PencilLine} title="Edit Info" style="gap-1 edit-info-text-style" secondaryBtn isHover={false} />
            </div>
